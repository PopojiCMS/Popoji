...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => str_replace('/po-content/filemanager/dialog.php', '', explode('?', $_SERVER['REQUEST_URI'], 2)[0]).'/po-content/uploads/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'relative_path_from_current_pos'          => array( 'medium/' ), //relative path of the image folder from the current position on upload folder
    'relative_image_creation_name_to_prepend' => array( 'medium_' ), //name to prepend on filename
    'relative_image_creation_name_to_append'  => array( '' ), //name to append on filename
    'relative_image_creation_width'           => array( 640 ), //width of image
    'relative_image_creation_height'          => array( 480 ), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
