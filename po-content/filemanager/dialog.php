...
<!-- header div end -->
	...
	<div class="span12">
		...
		foreach ($files as $file_array) {
			...
			?>
				<li data-name="<?php echo $file ?>" class="<?php if($file=='..') echo 'back'; else echo 'dir';?>" <?php if($usersubdir != '') echo ' style="display:none;"';?> <?php if(($filter!='' && stripos($file,$filter)===false)) echo ' style="display:none;"';?>><?php
