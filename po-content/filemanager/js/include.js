	...
	jQuery(document).ready(function() {
		...
		if ("" != r)
			if (1 == jQuery("#crossdomain").val()) t.postMessage({
				...
				v.val(a).trigger("change"), 0 == n ? "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(r) : "function" == typeof t[n] && t[n](r), Q()
			}
		...
		if ("" != a)
			if (1 == jQuery("#crossdomain").val()) r.postMessage({
				...
				c.val(e).trigger("change"), 0 == t ? "function" == typeof r.responsive_filemanager_callback && r.responsive_filemanager_callback(a) : "function" == typeof r[t] && r[t](a), Q()
			}
		else apply_any(o)
