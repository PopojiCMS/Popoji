...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('album.create_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('album.create_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::open(['url' => '/dashboard/albums', 'class' => 'form-horizontal']) !!}
			<div class="card-body pd-b-0">
				...
				@include ('backend.album.form', ['formMode' => 'create'])
			</div>
