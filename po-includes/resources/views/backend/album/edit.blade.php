...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('album.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('album.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($album, [
			'method' => 'PATCH',
			'url' => ['/dashboard/albums', Hashids::encode($album->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.album.form', ['formMode' => 'edit'])
			</div>
