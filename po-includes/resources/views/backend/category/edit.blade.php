...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('category.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('category.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($category, [
			'method' => 'PATCH',
			'url' => ['/dashboard/categories', Hashids::encode($category->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.category.form', ['formMode' => 'edit'])
			</div>
