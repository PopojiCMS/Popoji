@extends('layouts.app')
@section('title', __('comment.edit_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('comment.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('comment.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($comment, [
			'method' => 'PATCH',
			'url' => ['/dashboard/comments', Hashids::encode($comment->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.comment.form', ['formMode' => 'edit'])
			</div>
