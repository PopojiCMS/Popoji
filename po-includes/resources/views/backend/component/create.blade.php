@extends('layouts.app')
@section('title', __('component.create_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item"><a href="{{ url('/dashboard/components/table') }}">{{ __('general.components') }}</a></li>
					<li class="breadcrumb-item active" aria-current="page">{{ __('component.create_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('component.create_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::open(['url' => '/dashboard/components', 'class' => 'form-horizontal']) !!}
			<div class="card-body pd-b-0">
				...
				@include ('backend.component.form', ['formMode' => 'create'])
			</div>
