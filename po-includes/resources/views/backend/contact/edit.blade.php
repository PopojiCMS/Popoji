@extends('layouts.app')
@section('title', __('contact.edit_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('contact.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('contact.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($contact, [
			'method' => 'PATCH',
			'url' => ['/dashboard/contacts', Hashids::encode($contact->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.contact.form', ['formMode' => 'edit'])
			</div>
