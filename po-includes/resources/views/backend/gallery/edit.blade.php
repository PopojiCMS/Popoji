@extends('layouts.app')
@section('title', __('gallery.edit_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('gallery.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('gallery.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($gallery, [
			'method' => 'PATCH',
			'url' => ['/dashboard/gallerys', Hashids::encode($gallery->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.gallery.form', ['formMode' => 'edit'])
			</div>
