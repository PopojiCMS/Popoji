@extends('layouts.app')
@section('title', __('subscribe.edit_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('subscribe.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('subscribe.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($subscribe, [
			'method' => 'PATCH',
			'url' => ['/dashboard/subscribes', Hashids::encode($subscribe->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.subscribe.form', ['formMode' => 'edit'])
			</div>
