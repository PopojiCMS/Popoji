@extends('layouts.app')
@section('title', __('tag.create_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('tag.create_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('tag.create_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::open(['url' => '/dashboard/tags', 'class' => 'form-horizontal']) !!}
			<div class="card-body pd-b-0">
				...
				@include ('backend.tags.form', ['formMode' => 'create'])
			</div>
