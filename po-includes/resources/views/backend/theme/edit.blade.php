@extends('layouts.app')
@section('title', __('theme.edit_title'))
...
@section('content')
		...
		<div>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-style1 mg-b-10">
					...
					<li class="breadcrumb-item active" aria-current="page">{{ __('theme.edit_title') }}</li>
				</ol>
			</nav>
			<h4 class="mg-b-0 tx-spacing--1">{{ __('theme.edit_title') }}</h4>
		</div>
	...
	<div class="card">
		{!! Form::model($theme, [
			'method' => 'PATCH',
			'url' => ['/dashboard/themes', Hashids::encode($theme->id)],
			...
			<div class="card-body pd-b-0">
				...
				@include ('backend.theme.form', ['formMode' => 'edit'])
			</div>
